        ...
        {!wallet.connected ? (
          <div className="bg-white dark:bg-dark-surface rounded-xl p-8 shadow-sm border border-gray-100 dark:border-dark-border text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Connect your Phantom wallet to access the sniping tools.
            </p>
            <button 
              ...
              onClick={() => {
                // Directly target the Phantom adapter
                const walletBtn = document.querySelector('.wallet-adapter-button-trigger') as HTMLButtonElement;
                if (walletBtn) {
                  walletBtn.click();
                  
                  // If the modal opens, we'll try to auto-select Phantom
                  setTimeout(() => {
                    const phantomBtn = document.querySelector('.wallet-adapter-button[data-wallet="Phantom"]') as HTMLButtonElement;
                    if (phantomBtn) {
                      phantomBtn.click();
                    }
                  }, 200);
