      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#features" className="text-gray-400 hover:text-accent">
                  Features
                </Link>
              </li>
              <li>
                <Link href="#dashboard" className="text-gray-400 hover:text-accent">
                  Dashboard
                </Link>
              </li>
              <li>
                <Link href="#token" className="text-gray-400 hover:text-accent">
                  $SOB Token
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link href="#" className="text-gray-400 hover:text-accent text-sm">
              Terms of Service
            </Link>
            <Link href="#" className="text-gray-400 hover:text-accent text-sm">
              Privacy Policy
